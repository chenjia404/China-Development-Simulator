...
更细的架构、存档迁移、校准顺序与故障排查见 [程序维护与扩展指南](./程序维护与扩展指南.md)。强制约束见 [AGENTS.md](./AGENTS.md)。玩法与已实现机制见 [README.md](./README.md)。经济变量与反馈回路见 [经济模拟算法设计.md](./经济模拟算法设计.md)。
...
- 阅读 `AGENTS.md`、本指南、`程序维护与扩展指南.md` 相关章节
