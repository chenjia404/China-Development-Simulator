...
export const historicalModifierLabels: Readonly<Record<string, string>> = {
  ...
  "capital.remittanceInvestmentRate": "侨汇转投资比例",
  ...
  "trade.remittanceReserveRetention": "侨汇结汇留存比例",
  ...
  "transport.railInvestmentEfficiency": "铁路投资效率",
  "transport.highwayInvestmentEfficiency": "公路投资效率",
  "transport.expresswayInvestmentEfficiency": "高速公路投资效率",
  "transport.urbanInvestmentEfficiency": "城市公共交通投资效率",
  "transport.portCapacityGrowth": "港口吞吐能力增长",
  "transport.logisticsEfficiency": "物流效率",
