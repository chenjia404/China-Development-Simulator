...
test("客户端展示可提前发动的治理、工业化与改革国策", async () => {
  ...
  assert.match(source, /提前实施四三方案/);
  assert.match(source, /提前推进城市经济体制改革/);
  assert.match(source, /提前承认私营经济法律地位/);
  assert.match(source, /提前启动关贸总协定复关申请/);
  assert.match(source, /国家谈判与涉外法治能力达标/);
  ...
  assert.match(source, /颁布义务教育法/);
  assert.match(source, /落实九年义务教育/);
  ...
  assert.match(source, /交易所成为永久金融基础设施/);
});
